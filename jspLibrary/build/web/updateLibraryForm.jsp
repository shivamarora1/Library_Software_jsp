<%-- 
    Document   : updateLibraryForm
    Created on : May 24, 2017, 3:07:39 PM
    Author     : Shivam
--%>
...
<h2>Click on Update to Change Book in the Library</h2>
        <table>
            <tr>
                <th>Book ID</th>
                <th>Name</th>
...
ResultSet rs=stmt.executeQuery("SELECT * FROM books");
                ...
                <tr bgcolor="#DEB887">
                    ...
                    <td><a href="updateBook.jsp?id=<%=rs.getString("book_id")%>">Update</a></td>
                </tr>
                <%}%>
        </table>
